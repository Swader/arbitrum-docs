...
- Check sidebar links: `yarn check-sidebar-links`
...
| **Use simple English**        | Avoid too articulate terms and highfalutin sentences | "Before delving into the journey of a transaction" | "Before exploring a transaction's journey" |
