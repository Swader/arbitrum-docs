...
For more technical detail about the transaction lifecycle, refer to the [Transaction Lifecycle deep dive](/build-decentralized-apps/transaction-lifecycle.mdx).
